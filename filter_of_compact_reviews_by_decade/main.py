...
def main():
    config_params = init_configs(["LOGGING_LEVEL", "INPUT_EXCHANGE", "OUTPUT_EXCHANGE","INPUT_QUEUE_OF_REVIEWS", "NUM_OF_DYN_OUTPUT_QUEUES", "DECADE_TO_FILTER","NUM_OF_INPUT_WORKERS"])
    output_queues = []
    ...
    filter = Filter(input_exchange=config_params["INPUT_EXCHANGE"],
