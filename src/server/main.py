...
def main():
    config_params = init_configs(["LOGGING_LEVEL", "SERVER_PORT", "INPUT_EXCHANGE_OF_QUERY_RESULTS", "INPUT_QUEUE_OF_QUERY_RESULTS", "INPUT_QUEUE_OF_MERGERS_CONFIRMS", "OUTPUT_EXCHANGE_OF_DATA", "OUTPUT_QUEUE_OF_REVIEWS", "OUTPUT_QUEUE_OF_BOOKS"])
