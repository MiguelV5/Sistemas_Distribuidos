...
def main():
    config_params = init_configs(["LOGGING_LEVEL", "HEALTH_CHECK_INTERVAL", "HEALTH_CHECK_TIMEOUT", "CONTROLLER_NAME", "NUM_OF_HEALTHCHECKERS"])
    ...
    health_checker = HealthChecker(int(config_params["HEALTH_CHECK_INTERVAL"]), 
                                   ...
                                   int(config_params["NUM_OF_HEALTHCHECKERS"])),
