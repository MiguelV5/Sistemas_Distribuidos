...
class DecadePreprocessor(MonitorableProcess):
    ...
    def __process_msg_from_prev_preprocessor(self, received_sys_msg: SystemMessage):
    ...
    def __apply_preprocessing_to_batch_and_send(self, received_sys_msg: SystemMessage):
        ...
        if payload_to_send_towards_expander:
            msg_for_expander = SystemMessage(SystemMessageType.DATA, received_sys_msg.client_id, self.controller_name, seq_num_to_send, payload_to_send_towards_expander).encode_to_str()
        ...
        for output_queue in self.output_queues_towards_mergers:
            if payload_to_send_towards_mergers[output_queue]:
                msg_for_merger = SystemMessage(SystemMessageType.DATA, received_sys_msg.client_id, self.controller_name, seq_num_to_send, payload_to_send_towards_mergers[output_queue]).encode_to_str()
