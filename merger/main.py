...
def main():
    config_params = init_configs(["LOGGING_LEVEL", "INPUT_EXCHANGE_OF_REVIEWS", "INPUT_EXCHANGE_OF_BOOKS", "OUTPUT_EXCHANGE", "INPUT_QUEUE_OF_REVIEWS",
                                  "INPUT_QUEUE_OF_BOOKS","OUTPUT_QUEUE_OF_COMPACT_REVIEWS", "OUTPUT_QUEUE_OF_FULL_REVIEWS"])
